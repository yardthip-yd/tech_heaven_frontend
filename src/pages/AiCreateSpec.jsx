...
const AiCreateSpec = () => {
  ...
  const generateSpec = async () => {
    ...
    const FINAL_PROMPT = AI_PROMPT.replace("{budget}", formData.budget).replace(
      "{useCase}",
      formData.useCase
    );
        ...
        <div className="w-full my-8 px-4 flex flex-col items-center relative z-10 ">
          <div className="bg-white p-6 pb-10 rounded-xl">
            <div className="text-center max-w-3xl mb-8 ">
              <h2 className="text-4xl md:text-4xl font-bold bg-gradient-to-r from-black via-blue-600 to-indigo-600 bg-clip-text text-transparent mb-4 relative inline-block">
                RECOMEND SPEC BY AI
              ...
              <p className="text-slate-600 text-md">
                Select your preferences, and we'll create a tailored computer
                build just for you.
              </p>
            </div>
              ...
              <div className="relative">
                  ...
                  <div className="flex flex-row gap-6">
                    <div className="space-y-2">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          hdlInputChange("budget", e.target.value)
                        }
                      >
                    ...
                    <div className="space-y-2">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          hdlInputChange("useCase", e.target.value)
                        }
                      >
                        <option value="" disabled>
                          Select use case...
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2 top-[calc(100%-25px)]">
                  <button
                    ...
                    className={`px-8 py-3 rounded-full font-medium shadow-lg transition-all duration-200 focus:ring-2 focus:ring-offset-2 ${
                      isGenerating
