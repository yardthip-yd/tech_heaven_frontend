        ...
        <div className="h-screen w-full flex items-center min-h-[500px]">
            ...
            <div className="m-auto p-8 flex flex-col items-center bg-white rounded-lg">
                ...
                >
                    ...
                    {/* Button Register */}
                    <button className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-full border-none mt-4 text-lg p-2">
                        Sign up
                    </button>
                ...
                <div className="flex gap-1">
                    ...
                    <div onClick={() => setIsLoginModalOpen(true)} className="hover:text-blue-500 transition-colors duration-300"><p className="text-sky-500">Sign In</p></div>
                </div>
