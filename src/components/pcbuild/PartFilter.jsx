  ...
  return (
    <div className="w-[1440px] mx-auto px-4 py-8">
      <div className="flex items-center justify-center mb-10 relative w-full lg:w-1/2 mx-auto">
        ...
        <input type="text" placeholder="Search products..." onChange={handleInputChange} value={searchItem} className="w-full px-10 py-2 rounded-lg border border-slate-300 shadow-sm" />
      </div>
    </div >
  );
}
