...
const authApi = {};
authApi.loginGoogle = async (profile) =>
  await axios.post("/auth/register-google", profile);
...
authApi.forgotPassword = async (body) =>
  await axios.post("/auth/forgotPassword", body);
authApi.resetPassword = async (body) =>
  await axios.put("/auth/resetPassword/", body);
